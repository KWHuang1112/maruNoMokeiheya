...
I'd like to show you guys how to design the profile picture on Facebook, and here we go!

I am using the software called "Blender" to create the profile picture and banner on FB.
...
If you want to use Chinese or Japanese instead, you need to change "Font" to the proper language which you like.
...
3. To bend text items into a circle, you need to create another item called "BezierCircle" first.
...
4. Almost done, you may adjust position or distance for each items, including "light" and "camera".
